...
Перед любой работой по ВКР сначала прочитать `/Users/fedor/Study/masters-degree/PROJECT_STATUS.md` — единственный авторитетный документ по теме, тезису, фрейму, валидации и плану. Эта memory — рабочий кэш Claude Code, синхронизирован с репо `<repo>/.claude/memory/`.
