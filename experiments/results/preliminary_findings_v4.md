...
### H2 (fatigue gradient): skip rate растёт по слоту

[Будет дополнено когда v2 agent simulation завершится; на данный момент v2 идёт]

### H3 (social contagion): корреляция активности друзей с собственной

[Будет дополнено когда v2 agent simulation завершится]
