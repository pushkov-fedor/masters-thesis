...
LLM source: `llm_agents_lhs_subset_12pts_en.json`
LHS точек у LLM: 12
Evals у LLM: 48
...
|---|---:|---:|---:|---:|---:|---|
| mean_overload_excess | 2 / 12 | 0.153 | 0.153 | 10 | 6 | FAIL |
| overflow_rate_slothall | 2 / 12 | 0.408 | 0.408 | 10 | 6 | FAIL |
| hall_utilization_variance | 12 / 12 | 0.800 | 0.590 | 0 | 0 | PASS |
| mean_user_utility | 12 / 12 | 0.669 | 0.645 | 0 | 0 | PASS |
...
|---|---:|---:|---:|
| mean_overload_excess | 9 / 12 | 2 / 2 | 1.00 |
| overflow_rate_slothall | 8 / 12 | 1 / 2 | 0.50 |
| hall_utilization_variance | 9 / 12 | 9 / 12 | 0.75 |
| mean_user_utility | 6 / 12 | 6 / 12 | 0.50 |
...
| 13 | no_policy | no_policy | yes | — | — |
| 18 | capacity_aware | capacity_aware | yes | 0.11 | 0.18 |
| 23 | no_policy | no_policy | yes | — | — |
| 27 | no_policy | capacity_aware | no | — | — |
| 31 | no_policy | no_policy | yes | — | — |
| 34 | no_policy | no_policy | yes | — | — |
| 36 | capacity_aware | capacity_aware | yes | 0.20 | 0.00 |
...
Overall median Spearman ρ = 0.769 ≥ 0.5 — **минимальный acceptance threshold пройден** (Q-O7 accepted). Это НЕ означает, что LLM полностью подтвердил параметрику; согласование умеренное и сильно неоднородное по метрикам.
