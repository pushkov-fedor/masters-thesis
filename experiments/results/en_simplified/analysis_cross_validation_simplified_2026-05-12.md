...
Дата: 2026-05-13
Parametric source: `analysis_simplified_diagnostic.json`
LLM source: `llm_agents_simplified_stratified_2026-05-12.json`
LHS точек у LLM: 12
Evals у LLM: 36
...
|---|---:|---:|---:|---:|---:|---|
| mean_overload_excess | 8 / 12 | 0.500 | 0.312 | 4 | 0 | PASS |
| overflow_rate_slothall | 8 / 12 | 0.000 | 0.171 | 4 | 0 | FAIL |
| hall_utilization_variance | 12 / 12 | 0.500 | 0.500 | 0 | 0 | PASS |
| mean_user_utility | 12 / 12 | 1.000 | 0.833 | 0 | 0 | PASS |
...
|---|---:|---:|---:|
| mean_overload_excess | 6 / 12 | 6 / 8 | 0.75 |
| overflow_rate_slothall | 3 / 12 | 3 / 8 | 0.38 |
| hall_utilization_variance | 11 / 12 | 11 / 12 | 0.92 |
| mean_user_utility | 10 / 12 | 10 / 12 | 0.83 |

## Per-LHS-row breakdown (по `metric_mean_overload_excess`)

| LHS | param top-1 | LLM top-1 | match | ρ | τ |
|---:|---|---|---|---:|---:|
| 0 | capacity_aware | capacity_aware | yes | 0.50 | 0.33 |
| 1 | capacity_aware | capacity_aware | yes | 0.50 | 0.33 |
| 2 | no_policy | capacity_aware | no | — | — |
| 6 | capacity_aware | capacity_aware | yes | 0.50 | 0.33 |
| 12 | capacity_aware | capacity_aware | yes | 0.50 | 0.33 |
| 14 | capacity_aware | no_policy | no | -0.50 | -0.33 |
| 17 | no_policy | capacity_aware | no | — | — |
| 31 | no_policy | capacity_aware | no | — | — |
| 33 | capacity_aware | capacity_aware | yes | 0.50 | 0.33 |
| 34 | capacity_aware | capacity_aware | yes | 1.00 | 1.00 |
| 36 | no_policy | capacity_aware | no | -0.50 | -0.33 |
| 39 | no_policy | capacity_aware | no | — | — |
...
Overall median Spearman ρ = 0.500 ≥ 0.5 — **минимальный acceptance threshold пройден** (Q-O7 accepted). Это НЕ означает, что LLM полностью подтвердил параметрику; согласование умеренное и сильно неоднородное по метрикам.
