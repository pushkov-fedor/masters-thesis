...
| Блок | Время, сек |
|---|---:|
| load_conference | 0.02 |
| generate_lhs | 0.10 |
| maximin_subset | 0.00 |
| prep (capacity / Φ / audience) | 885.53 |
| П1–П3 evals | 22.25 |
| П4 (llm_ranker) evals | 0.00 |
| **итого (run_lhs внутренний)** | **907.90** |
| **wallclock полный** | **908.14** |
...
- JSON: `lhs_parametric_demo_day_2026_en_2026-05-12.json`
- CSV (long-format): `lhs_parametric_demo_day_2026_en_2026-05-12.csv`
- этот отчёт: `lhs_parametric_demo_day_2026_en_2026-05-12.md`
